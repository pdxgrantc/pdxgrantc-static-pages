        ...
        return (
            <div class="flex justify-between">
                ...
                <div class="pr-[5vw] flex text-[2.75rem] font-semibold mobile:text-4xl">
                    ...
                    <a class="h-fit align-middle px-[1vw] py-[.5vw] hover:bg-button_pressed_color hover:cursor-pointer hover:ease-in-out duration-[350ms]" href="https://apps.pdxgrantc.com">Apps</a>
